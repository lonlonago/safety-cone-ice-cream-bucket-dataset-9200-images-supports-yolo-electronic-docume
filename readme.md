# Safety cone ice cream bucket dataset 9200 images supports YOLO electronic document category

# Body

Safety cone ice cream bucket dataset, 9200 images, supports YOLO, electronic data class, clear images, complete annotations, suitable for training target detection models.
...
The two items can be combined into one category cone (D040-1).
